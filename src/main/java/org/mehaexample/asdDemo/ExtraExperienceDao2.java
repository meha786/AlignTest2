...
//
//
//public class ExtraExperienceDao2 {
...
//	 */
//	public ExtraExperienceDao2() {
//		privaciesDao = new PrivaciesDao();
//		this.factory = StudentSessionFactory.getFactory();
//	}
//
//	public ExtraExperienceDao2(boolean test) {
//		if (test) {
...
//
//			List<ExtraExperiences> q = (List<ExtraExperiences>) query.list();
////			List<ExtraExperiences> n = new ArrayList<>();
////			for(ExtraExperiences e : q){
////				LocalDate lStart = ((Date) e.getStartDate()).toLocalDate();
////				LocalDate lEnd = ((Date) e.getEndDate()).toLocalDate();
////
////				e.setStartDate(Date.valueOf(lStart));
////				e.setEndDate(Date.valueOf(lEnd));  
////			}
//			//			for(ExtraExperiences e : q){
//			//				LocalDate lStart = ((Date) e.getStartDate()).toLocalDate();
//			//				LocalDate lEnd = ((Date) e.getEndDate()).toLocalDate();
